...
from dataloader.Data_tacred import Data
from model.sent_model_tacred import SENT_Model
...
class Trainer(nn.Module):
    ...
    def __init__(self, options, data_train, data_dev, data_test, data_noise):
        ...
        self.n_iter_num = 4 # 4/5/6 try it!
        self.n_posi_epoch = 50
        self.options.random = False # We do not set random as we didn't compare to ARNOR.
    ...
    def train_batch(self):
        ...
        self.batch_size = 50 # For TACRED positive training, we set batch_size=50.
        self.filter_relabel_tacred(0.15, cutrate=0., relabel_rate=0.8)
    ...
    def filter_relabel_tacred(self, prob_threshold=0., cutrate=-1, relabel_rate=-1, convergence_rate=0.99):
        ...
        print('Deleting {} noisy instances with threshold={}, p={}, r={}'.format(pred_num,
                                                                                     prob_threshold, noise_p, noise_r))
...
if __name__=='__main__':
    ...
    parser.add_argument("--vocab_file", type=str,
                        default='../RSN-master-mytorch/RSN/pretrain/glove/glove.6B.50d_word2id.json')
    parser.add_argument("--word2vec_file", type=str,
                        default='../RSN-master-mytorch/RSN/pretrain/glove/glove.6B.50d_mat.npy')
